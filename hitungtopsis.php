      ...
      <div style="margin-bottom: 250px" class="card">
        <div class="card-header ">
          <h3 style="margin-bottom: 20px; margin-top: 30px" class="card-title">
            <center>Cari Kriteria Menggunakan Nilai BOBOT (W)
          </h3>
        </div>
        ...
        ?>
          ...
          <!-- dibuat buka tutup -->
          <input type="button" class="btn btn-success" value="Perhitungan" onclick="js_hitung()" />
          <br />
          <br />
        ...
        ?>
          ...
          <div id="tampil_hitung" style="display:none;">
            <br />
            <h4 class="heading">
              Alternatif :
            </h4>

          ...
          <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <select readonly class="form-control" name="kriteria">
                                <?php
                              ...
                              <div class="form-group">
                                ...
                                <input readonly type="text" class="form-control" name="keterangan" value="<?php print($view_kelas[2]);?>"/>
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <a class="btn btn-warning" href="nilaiKriteriaUser.php">Kembali</a>
                              </div>
                            ...
                            <?php
                                      ...
                                      ';
                                      echo '<meta http-equiv="refresh" content="1; url=nilaiKriteriaUser.php" />';

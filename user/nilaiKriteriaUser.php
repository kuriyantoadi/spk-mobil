    ...
    <div class="col-md-12">
      <div class="card ">
        <div class="card-header ">
          ...
          <!--<a href="nilaiKriteriaTambahUser.php" class="btn btn-primary btn-sm">Tambah Kriteria</a>-->
            ...
            <tbody>
                ...
                while ($row=mysql_fetch_array($sql)){?>
                  <tr class='td' bgcolor='#FFF'>
                    ...
                    <td><center>
                        <a class="btn btn-warning btn-sm" href=nilaiKriteriaEditUser.php?idk=<?= $row['id_tkriteria'] ?> >Ubah</a>

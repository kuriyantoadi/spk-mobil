                          ...
                          <tr>
                            ...
                            <td width="200">
                              <div class="form-group">
                                ...
                                <div class="radio">
                                  <label><input required type="radio" name="kepentingan<?php echo $datakriteria['id_kriteria']; ?>" value="<?php echo $datakriteria['nkriteria']; ?>"> <?php echo $datakriteria['keterangan']; ?>
                                    [<?php echo $datakriteria['nkriteria']; ?>]</label>
                                </div>

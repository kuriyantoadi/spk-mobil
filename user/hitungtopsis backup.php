              ...
              <td width="200"> 
                ...
                <td width="200"> 
                    <div class="form-group">
                              <?php
                                                $querykriteria = mysql_query("SELECT * FROM kriteria,tb_nilai_kriteria WHERE kriteria.id_kriteria = tb_nilai_kriteria.id_kriteria AND tb_nilai_kriteria.id_kriteria='$r[id_kriteria]'");
...
else 
{
   ...
   $alternatif = array(); //array("Galaxy", "iPhone", "BB", "Lumia");
    ...
    {
        $alternatif[$i] = $dataalternatif['mobil'];
        $i++;
    }
